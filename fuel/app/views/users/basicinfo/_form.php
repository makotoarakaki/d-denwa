<?php echo Form::open('users/basicinfo/create', array("class"=>"form-horizontal")); ?>
    ...
    <fieldset>
		<div class="form-group">
			<div class="col-md-4 col-xs-7">
				<h2>店舗名</h2>
					<?php echo Form::input('temponame', Input::post('title', isset($info) ? $info->temponame : ''), array('class' => 'form-control')); ?>
			</div>
		</div>
	</fieldset>
    <fieldset>
		<div class="form-group">
			<div class="col-md-4 col-xs-7">
				<h2>電話番号</h2>
					<?php echo Form::input('telno', Input::post('title', isset($info) ? $info->telno : ''), array('class' => 'form-control')); ?>
			</div>
		</div>
	</fieldset>
	<br />
