...
//                        alert("ポストされた内容:\n" + postdata.personname.text());
    ...
    jQuery(document).ready(function()
    {
        ...
        jQuery("#list").jqGrid({
            ...
            datatype: "local",
			mtype:"POST",
            colNames:['No.', 'ID', '顧客ＩＤ', '顧 客 名', '担 当 者', '月 日', '時 間', 'メ ニ ュー', 'メ モ'],
...
// 				       {index:'customerid', name:'customerid', hidden:true, editrules:{ edithidden:true, editable:false }},
                       {index:'customerid', name:'customerid', hidden:true },
